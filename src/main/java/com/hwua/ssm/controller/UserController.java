...
public class UserController {
    ...
    @RequestMapping(value = "/saveOrUpUser", produces = "text/html;charset=UTF-8")
    @RequiresPermissions("user_edit")
    @ResponseBody
    public String saveOrUpUser(User user) {
        ...
        if (a == 1) {
            ...
            ur = new UpdateResult(false, "用户名称重复！");
        } else {
    ...
    @RequiresPermissions("user_distribute")
    @ResponseBody
